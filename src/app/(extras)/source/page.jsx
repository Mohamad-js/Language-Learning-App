...
return (
   <div className="absolute top-0 left-0 w-full min-h-dvh flex flex-col justify-center items-start pt-13 p-5 bg-background">
                  ...
                  {words.map((item, index) => (
                     <div key={index} className="flex-1 p-3 flex justify-between items-center">
                        <div className="w-full flex justify-between items-center">
                           ...
                           <p className="text-sm">{item.BrE}</p>
                           <p className="text-sm">{item.AmE}</p>
                        </div>
                     </div>
                  ))}
               </div>
