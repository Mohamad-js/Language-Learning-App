...
import { b2WordList } from '@/data/b2WordList';
...
// Retrieve data from localStorage on mount
   useEffect(() => {
      try {
         ...
         const totalWordsLearnt = (slug * 10) + Number(a1WordsLearnt) + Number(a2WordsLearnt) + Number(b1WordsLearnt) + Number(c1WordsLearnt) + Number(c2WordsLearnt)
   ...
   const save = () => {
      ...
      localStorage.setItem(`currentLesson-B2`, JSON.stringify(slug));
   }
