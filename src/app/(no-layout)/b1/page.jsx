...
function B1() {
   ...
   useEffect(() => {
      const current = JSON.parse(localStorage.getItem(`currentLesson-B1`)) || 0;
      current < 90 ? setNextLesson(Number(current) + 1) : null

      if(!isLoading) {
         const currentProgress = (Number(current) * 100) / 90
