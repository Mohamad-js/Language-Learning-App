...
function C2() {
   ...
   useEffect(() => {
      ...
      for (let i = 1; i <= 92; i++) {
         ...
         const unknowns = JSON.parse(localStorage.getItem(`unknownWords-${i}-C2`)) || [];
   ...
   const goReview = (lessonRequested) => {
      ...
      localStorage.setItem(`levelRequested`, JSON.stringify('C2'));
   ...
   return (
      <div className={styles.container}>
         ...
         <div className={styles.top}>
            <div className={styles.mainTitle}>C2 Vocabulary</div>
                  ...
                  >
                     ...
                     <div className={styles.btns}>
                        ...
                        <button className={styles.lessonBtn}>
                           <Link href={`/c2/${lessonNumber}`} onClick={switchPreview}> PREVIEW </Link>
                        </button>

                        <button className={styles.lessonBtn}>
                           <Link href={`/c2/${lessonNumber}`}>START</Link>
                        </button>
                     </div>
